...
export const createInjectableBaseStyles = () => () =>
  injectGlobal`
      ...
      .react-datepicker__year-text--in-selecting-range:not(.react-datepicker__year-text--in-range) {
        background-color: rgba(#216ba5, 0.5);
      }

      .react-datepicker__day--in-range:not(.react-datepicker__day--in-selecting-range),
      .react-datepicker__month-text--in-range:not(.react-datepicker__month-text--in-selecting-range),
      .react-datepicker__quarter-text--in-range:not(.react-datepicker__quarter-text--in-selecting-range),
      .react-datepicker__year-text--in-range:not(.react-datepicker__year-text--in-selecting-range) {
        background-color: #f0f0f0;
        color: #000;
      }
